...
public class Thread_InterruptLock implements Runnable {
    public static ReentrantLock lock1 = new ReentrantLock();
    public static ReentrantLock lock2 = new ReentrantLock();
    int lock;

    public Thread_InterruptLock(int lock) {
        this.lock = lock;
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        Thread_InterruptLock lock1 = new Thread_InterruptLock(1);
        Thread_InterruptLock lock2 = new Thread_InterruptLock(2);
